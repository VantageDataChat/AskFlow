...
(function () {
    ...
    var translations = {
        'zh-CN': {
            ...
            'admin_multimodal_whisper_desc': 'OpenAI Whisper 用于将视频中的语音转录为文字，需要 Python 3.8+ 环境。',
            'admin_multimodal_whisper_step1_title': '步骤 1：安装 Python',
            'admin_multimodal_whisper_step1_desc': '确保系统已安装 Python 3.8 或更高版本。可运行 <code>python --version</code> 检查。',
            'admin_multimodal_whisper_step1_download': '如未安装，请从 <a href="https://www.python.org/downloads/" target="_blank" rel="noopener">python.org</a> 下载安装。',
            'admin_multimodal_whisper_step2_title': '步骤 2：安装 Whisper',
            'admin_multimodal_whisper_step2_gpu': '如有 NVIDIA GPU，建议先安装 CUDA 版 PyTorch 以获得 GPU 加速：',
            'admin_multimodal_whisper_step3_title': '步骤 3：验证安装',
            'admin_multimodal_whisper_step3_desc': '如果显示帮助信息则安装成功。首次转录时会自动下载所选模型。',
            'admin_multimodal_whisper_note_title': '⚠️ 注意事项',
            'admin_multimodal_whisper_note1': 'Whisper 依赖 FFmpeg，请确保 FFmpeg 已安装',
            'admin_multimodal_whisper_note2': '无 GPU 时也可运行，但转录速度会较慢',
            'admin_multimodal_whisper_note3': '模型文件会缓存在 <code>~/.cache/whisper/</code> 目录',
        ...
        'en-US': {
            ...
            'admin_multimodal_whisper_desc': 'OpenAI Whisper is used to transcribe speech from videos to text. Requires Python 3.8+.',
            'admin_multimodal_whisper_step1_title': 'Step 1: Install Python',
            'admin_multimodal_whisper_step1_desc': 'Ensure Python 3.8 or higher is installed. Check with <code>python --version</code>.',
            'admin_multimodal_whisper_step1_download': 'If not installed, download from <a href="https://www.python.org/downloads/" target="_blank" rel="noopener">python.org</a>.',
            'admin_multimodal_whisper_step2_title': 'Step 2: Install Whisper',
            'admin_multimodal_whisper_step2_gpu': 'If you have an NVIDIA GPU, install CUDA-enabled PyTorch first for GPU acceleration:',
            'admin_multimodal_whisper_step3_title': 'Step 3: Verify Installation',
            'admin_multimodal_whisper_step3_desc': 'If help information is displayed, installation is successful. The selected model will be downloaded automatically on first transcription.',
            'admin_multimodal_whisper_note_title': '⚠️ Notes',
            'admin_multimodal_whisper_note1': 'Whisper depends on FFmpeg. Ensure FFmpeg is installed',
            'admin_multimodal_whisper_note2': 'Can run without GPU, but transcription will be slower',
            'admin_multimodal_whisper_note3': 'Model files are cached in <code>~/.cache/whisper/</code> directory',
